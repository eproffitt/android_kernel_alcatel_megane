...
static kal_int32 g_rtc_fg_soc = 0;
...
//4. update DOD0 after booting Xs
	...
	/**************  Fuel Gauge SOC from RCT ~~~Start **************/
        g_rtc_fg_soc = get_rtc_spare_fg_value();
        xlog_printk(ANDROID_LOG_DEBUG, "Power/Battery", "Fuel Gauge from RTC:%d; from VBAT:%d.\r\n", g_rtc_fg_soc, gFG_capacity_by_v);
