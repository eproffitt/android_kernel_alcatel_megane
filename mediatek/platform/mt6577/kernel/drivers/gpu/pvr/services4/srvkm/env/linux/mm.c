...
typedef struct _DEBUG_MEM_ALLOC_REC
{
    ...
    IMG_UINT32              ui32Line;
#if defined(MTK_DEBUG_IOCTL_MSG)
    IMG_CHAR                acDebugMsg[MTK_DEBUG_IOCTL_MSG_LENGTH];
#endif
...
#ifdef MTK_DEBUG_LINUX_MEMORY_ALLOCATIONS
...
static void ProcSeqShowMemoryRecords(struct seq_file *sfile,void* el)
{
    ...
    if (psRecord->eAllocType != DEBUG_MEM_ALLOC_TYPE_KMEM_CACHE)
    {
		seq_printf(sfile,
                           ...
                           psRecord->pid,
                           "NULL",
#if defined(MTK_DEBUG_LINUX_MEMORY_ALLOCATIONS)
