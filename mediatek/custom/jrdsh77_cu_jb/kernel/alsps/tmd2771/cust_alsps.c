...
int TMD2771_CMM_PPCOUNT_VALUE = 0x0A;  /* modify by tao.zhang.  2012-12-18.   for improve the sensitvity of psensor.*/
int ZOOM_TIME = 4;
int TMD2771_CMM_CONTROL_VALUE = 0x20; /* modify by tao.zhang.  2012-12-18.   for improve the sensitvity of psensor.*/
