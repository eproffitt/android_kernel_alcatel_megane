...
Shading:{
    {set:{//00 Preview
        0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x10000000,0x9051903D,0x00443C60,0x00590042,0x20202020,
    }},
    {set:{//01 Capture
        0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x10000000,0xF066F04C,0x004885A0,0x00680057,0x20202020,
    }},
    {set:{//02
...
EE:{// EE
    ...
    {set:{//04 Preview ISO1600 (middle sharpness)
        0x00000028, 0x007F3720, 0x000E0068, 0x00DB049A, 0x011C01C2, 0x013800EA, 0xFFFFFB0D, 
    }},
...
Saturation:{
    ...
    {set:{//04 (middle saturation)
        0x00010708, 0x1020E0F0, 0x1A343434, 0x1A000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }},
...
CCM:{
    {set:{//00
        0x021504DB, 0x043A0435, 0x01570422, 0x00110492, 0x01810000, 
    }},
    {set:{//01
        0x021504DB, 0x043A0435, 0x01570422, 0x00110492, 0x01810000, 
    }},
...
Gamma:{
    {set:{//00
        0x341B0E07, 0x756B5E4D, 0x9F92857D, 0xCDC2B7AB, 0xF8F0E8E0, 
    }},
            }
