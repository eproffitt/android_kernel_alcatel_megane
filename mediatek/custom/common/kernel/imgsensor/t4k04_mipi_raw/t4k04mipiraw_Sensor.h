...
typedef struct
{
	...
	#define T4K04_PV_SCALER_FACTOR					    	3
	#define T4K04_FULL_SCALER_FACTOR					    1
	...
	#define T4K04_MIN_LINE_LENGTH						0x0AA4  
	#define T4K04_MIN_FRAME_LENGTH						0x0214  
	
	#define T4K04_MAX_LINE_LENGTH						0xCCCC
	#define T4K04_MAX_FRAME_LENGTH						0xFFFF
