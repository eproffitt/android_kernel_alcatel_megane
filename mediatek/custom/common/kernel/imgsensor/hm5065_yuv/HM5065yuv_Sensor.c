...
static void HM5065_Sensor_Driver_Init(void)
	...
	HM5065_write_cmos_sensor(0x00B3,0xc9); //0x80 20130115 
...

{
	...
	mdelay(200);													 //Delay for wait buffer data off 
	HM5065_write_cmos_sensor(0x00B5, 0x01); 
	...
	mdelay(200);													 //Delay for wait stable image 
...

{
  ...
  HM5065_write_cmos_sensor(0x0010, 0x02);
	mdelay(100);														//Delay for wait buffer data off 							
...
//if (af_type !=AF_INF)
	...
	mdelay(200);													//Delay for wait AF action finish 
...
//			HM5065_write_cmos_sensor(0x01A3,0x00);//Bgain
				...
				HM5065_write_cmos_sensor(0x01A1,0x62);
				HM5065_write_cmos_sensor(0x01A2,0x08);
...
//			HM5065_write_cmos_sensor(0x01A3,0x00);//Bgain   
	 			HM5065_write_cmos_sensor(0x01A0,0x03);
				HM5065_write_cmos_sensor(0x01A1,0x4F);
				HM5065_write_cmos_sensor(0x01A2,0x00);
				HM5065_write_cmos_sensor(0x01A3,0x01);
 #else
...
//			HM5065_write_cmos_sensor(0x01A3,0x20);//Bgain
				HM5065_write_cmos_sensor(0x01A0,0x03);
				HM5065_write_cmos_sensor(0x01A1,0x10);
				HM5065_write_cmos_sensor(0x01A2,0x00);
				HM5065_write_cmos_sensor(0x01A3,0x52);
            break;
...
//			HM5065_write_cmos_sensor(0x01A3,0x40);//Bgain
				HM5065_write_cmos_sensor(0x01A0,0x03);
				HM5065_write_cmos_sensor(0x01A1,0x05);
				HM5065_write_cmos_sensor(0x01A2,0x00);
				HM5065_write_cmos_sensor(0x01A3,0x7F);			
            break;
...
//			HM5065_write_cmos_sensor(0x01A3,0x30);//Bgain
				HM5065_write_cmos_sensor(0x01A0,0x03);
				HM5065_write_cmos_sensor(0x01A1,0x39);
				HM5065_write_cmos_sensor(0x01A2,0x00);
				HM5065_write_cmos_sensor(0x01A3,0x59);
            break;
