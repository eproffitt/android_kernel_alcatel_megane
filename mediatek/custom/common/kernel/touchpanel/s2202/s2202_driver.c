...
#define EELY    7
#define SUCCESS 8
/* BEGIN PN: DTS2012120404509  , Modified by f00184246,2012-12-03*/
/*Add new module info  */
#define MUTTO   9
#define JUNDA   10
#define BIEL    11
#define JDI     12
/* END PN: DTS2012120404509  , Modified by f00184246,2012-12-03*/
...
static void tpd_work_func(struct work_struct *work)
{
	...
	for (i = 0; i < ts->points_supported; i++) {
		...
		if(flag==0&&i==(ts->points_supported-1))
		{
		   	tpd_up(0, 0);
		   	TPD_EM_PRINT(ppt->raw_x, ppt->raw_y, ppt->x, ppt->y, ppt->z, 0);
		}
...
/* BEGIN PN: DTS2012091903381  , add by f00184246,2012-09-19*/


/* BEGIN PN:DTS2012120404509  ,Added by f00184246, 2012/12/03*/




/*END PN:DTS2012120404509  ,Added by f00184246, 2012/12/03*/
...
static int tpd_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    int tp_type = 0;
	/* END PN: DTS2012091903381  , add by f00184246,2012-09-19*/
    /* BEGIN PN:DTS2012120404509,Added by f00184246, 2012/12/03*/
       int data = 0;
   /* END PN:DTS2012120404509  ,Added by f00184246, 2012/12/03*/
...
/* < DTS2012040603460 gkf61766 20120406 end */
	...
	//}
	/* DTS2012031404176  linghai 20120314 end > */
    /* BEGIN PN:DTS2012120404509  ,Deleted by f00184246, 2012/12/03*/
...
int RMI4_wait_attn_hw(struct i2c_client * client,int udleay)
{
	...
	do{
		...
		/* END PN:DTS2012120404509   ,Deleted by f00184246, 2012/12/03*/
...
static int i2c_update_firmware(struct i2c_client *client) 
{
    ...
    /* BEGIN PN:DTS2012120404509  ,Added by f00184246, 2012/12/03*/
    const char *filename_COB="/tp/1294018.img";
    /* END PN:DTS2012120404509 ,Added by f00184246, 2012/12/03*/
	char *filename=NULL;
    /* BEGIN PN:DTS2012120404509  ,Modified by f00184246, 2012/12/03*/
