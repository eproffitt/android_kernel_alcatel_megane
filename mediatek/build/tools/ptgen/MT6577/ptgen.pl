...
my $ChangeHistory = "3.4 Support Protect Partition\n";
...
$MTK_PROTECTED_DATA_SUPPORT=$ENV{MTK_PROTECTED_DATA_SUPPORT};
...
if($EMMC_SUPPORT eq "yes"){
	...
	if($MTK_PROTECTED_DATA_SUPPORT eq "yes"){
		$SHEET_NAME = $SHEET_NAME ." protect" ;
	}
}else{
