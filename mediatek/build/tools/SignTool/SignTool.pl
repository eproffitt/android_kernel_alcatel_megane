...
# File Check
##########################################################
my @imgs_need_sign = ("boot.img", "logo.bin", "recovery.img", "secro.img", "system.img", "lk.bin","custpack.img","userdata.img","mobile_info.img");
...
my @imgs_need_sign = ("MBR", "EBR1", "EBR2", "EBR3", "EBR4");
